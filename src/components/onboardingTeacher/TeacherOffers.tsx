...
export default function TeacherOffers() {
  ...
  return (
    <section className="min-h-screen max-[1120px]:w-[80%]">
      <article className="text-jet flex flex-col items-center min-h-screen bg-secondary-bg w-280 pb-5 max-[1120px]:w-full">
        <form
