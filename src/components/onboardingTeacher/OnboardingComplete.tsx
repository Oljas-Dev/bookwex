    ...
    <>
      ...
      <div className="bg-secondary-bg flex flex-col gap-4 items-center w-[50%] rounded-xl px-4 py-6 border border-jet/30 max-[800px]:w-[80%] max-[500px]:px-2 max-[500px]:text-center max-[400px]:w-[95%]">
        <div className="flex flex-col gap-6 text-lg [&_p]:text-lg">
          ...
          <span className="flex">
            <p>
              Congratulations! Your Bookwex profile is live, and you're ready to
              welcome your first students. Your Profile section is your teacher
              dashboard.
            </p>
          </span>
          ...
          <p>
            Every successful tutor starts with a single student. We hope Bookwex
            helps you spend less time managing bookings and more time doing what
            you love—teaching. Thank you for trusting us to be part of your
            journey. We're excited to see your business grow and can't wait to
            celebrate your milestones along the way. Here's to new students,
            meaningful lessons, and a thriving tutoring business.
          </p>
